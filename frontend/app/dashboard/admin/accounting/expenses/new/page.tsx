...
export default function NewExpensePage() {
  ...
  const [form, setForm] = useState({ vendor: '', amount: '', date: '', category: '' });
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <Card>
        <CardHeader title="Add Expense" subtitle="Create a new expense entry" />
        <CardBody>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm text-neutral-600">Vendor</label>
              <input name="vendor" value={form.vendor} onChange={handleChange} className="mt-1 w-full rounded-md border p-2" />
            </div>
            <div>
            ...
            <div>
              ...
              <input name="category" value={form.category} onChange={handleChange} className="mt-1 w-full rounded-md border p-2" />
            </div>
            <div>
            ...
            <div className="flex gap-2">
              ...
              <Button variant="ghost" onClick={() => router.push('/accounting/expenses')}>Cancel</Button>
            </div>
          </form>
        </CardBody>
      </Card>
